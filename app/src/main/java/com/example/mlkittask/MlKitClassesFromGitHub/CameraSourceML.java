...
public class CameraSourceML {
    ...
    private static final String TAG = "CameraSourceML";
    ...
    public CameraSourceML(Activity activity) {
    ...
    public synchronized CameraSourceML start() throws IOException {
        if (camera != null) {
            Log.d(TAG, "start: Camera is null");
            return this;
        }
        ...
        Log.d(TAG, "start: Camera starting preview");
        camera.startPreview();

        processingThread = new Thread(processingRunnable);
        processingRunnable.setActive(true);
        processingThread.start();
        Log.d(TAG, "start: Camera printing this"+this);
        return this;
    }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public synchronized CameraSourceML start(SurfaceHolder surfaceHolder) throws IOException {
        if (camera != null) {
            return this;
        }
